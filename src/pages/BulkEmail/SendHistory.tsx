...
import {
  ...
  Mail, ChevronLeft, ChevronRight, Sparkles, Plus, BarChart3, ArrowLeft,
} from 'lucide-react'
...
export default function SendHistory() {
  ...
  return (
    <Layout title="Send History" subtitle="View past email campaigns and their performance" actions={

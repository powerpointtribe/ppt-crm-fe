    ...
    <Layout title="">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <button
            onClick={() => {
              // Return to the First Timers list at its saved state (page/tab/
              // filters), not just the previous history entry.
              let query = ''
              try {
                query = sessionStorage.getItem('ft-list-search') || ''
              } catch {
                /* ignore storage errors */
              }
              navigate(query ? `/first-timers?${query}` : '/first-timers')
            }}
